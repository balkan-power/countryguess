...
def main():
    ...
    CountryFacts = {
        ...
        "Norway": [
            "This country is known for its fjords and stunning natural landscapes.",
            "This country is one of the richest in the world by GDP per capita.",
            "This country is not a member of the EU but is part of the Schengen Area.",
            "This country has a strong welfare system and high quality of life.",
            "This country exports oil, gas, and seafood.",
            "This country is home to the Sami indigenous people.",
            "This country is a constitutional monarchy.",
            "This country is one of the most environmentally conscious in the world.",
            "This country often ranks among the happiest globally.",
            "This country’s capital is Oslo.",
        ],
    
        "Cyprus": [
            "This country is an island nation in the Eastern Mediterranean.",
            "This country has both Greek and Turkish communities.",
            "This country’s capital is Nicosia, the last divided capital in Europe.",
            "This country has a long and rich ancient history, influenced by Greeks and Romans.",
            "This country is a member of the EU.",
            "This country uses the Euro as its currency.",
            "This country is known for its beaches and tourism industry.",
            "This country has had a UN peacekeeping presence since the 1970s.",
            "This country produces halloumi cheese.",
            "This country has significant offshore natural gas reserves.",
        ],
    
        "Belize": [
            "This country is the only English-speaking country in Central America.",
            "This country is home to the second largest barrier reef in the world.",
            "This country has a diverse population including Creole, Mestizo, and Garifuna people.",
            "This country’s capital is Belmopan, but Belize City is the largest city.",
            "This country was formerly known as British Honduras.",
            "This country is part of the Commonwealth and recognizes the British monarch.",
            "This country is known for ecotourism and biodiversity.",
            "This country has Mayan archaeological sites like Caracol and Xunantunich.",
            "This country’s economy relies on tourism, agriculture, and remittances.",
            "This country has protected large portions of its rainforest and marine ecosystems.",
        ],
    
        "Angola": [
            "This country is a major oil producer in Africa.",
            "This country’s capital is Luanda.",
            "This country was a Portuguese colony until 1975.",
            "This country experienced a long civil war that ended in 2002.",
            "This country’s official language is Portuguese.",
            "This country has a youthful population with over half under 25.",
            "This country has large diamond and mineral reserves.",
            "This country’s culture blends African traditions and Portuguese influences.",
            "This country is investing in post-war reconstruction and infrastructure.",
            "This country borders Namibia, the Democratic Republic of the Congo, and Zambia.",
        ],

        "Namibia": [
            "This country is one of the least densely populated in the world.",
            "This country’s capital is Windhoek.",
            "This country has the world’s oldest desert, the Namib Desert.",
            "This country gained independence from South Africa in 1990.",
            "This country has strong German colonial influence in architecture and language.",
            "This country is known for its wildlife and national parks like Etosha.",
            "This country is a major uranium producer.",
            "This country has a stable political system and democracy.",
            "This country has coastal access to the Atlantic Ocean.",
            "This country practices community-based wildlife conservation.",
        ],
        
        "Zimbabwe": [
            "This country is home to Victoria Falls, one of the largest waterfalls in the world.",
            "This country’s capital is Harare.",
            "This country has experienced significant economic challenges and hyperinflation.",
            "This country was formerly known as Rhodesia.",
            "This country’s official languages include English, Shona, and Ndebele.",
            "This country has a rich history including the Great Zimbabwe ruins.",
            "This country has a controversial land reform history.",
            "This country is known for its wildlife and safari tourism.",
            "This country has a multi-currency system after the collapse of the Zimbabwean dollar.",
            "This country’s economy relies heavily on mining and agriculture.",
        ],
    }
